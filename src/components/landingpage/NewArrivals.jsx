            ...
            <Container style={{backgroundColor:"#FEEEEE"}}>
                <Row >
                    <div className="d-flex" style={{padding:"0"}}>
                        <div className="" style={{backgroundColor:"#D6210E", margin:"0.5rem 0.5rem 0 0", color:"white", borderRadius:"0.2rem 0.2rem 0 0", padding:"0.5rem 1.5rem"}}>NEW ARRIVAL</div>
                        <div className="" style={{backgroundColor:"white", margin:"0.5rem 0.5rem 0 0", borderRadius:"0.2rem 0.2rem 0 0", padding:"0.5rem 1.5rem"}}>DISCOUNT PRODUCTS</div>
